...
window.onload= function(){
    ...
    document.getElementById("mainVideo").addEventListener("mouseover",entra);
    document.getElementById("botones").addEventListener("mouseover",entra);
    document.getElementById("barra").addEventListener("mouseover",entra);
    document.getElementById("mainVideo").addEventListener("mouseout", sale);
...
function entra(){
    document.getElementById("barra").style.zIndex="20";
    document.getElementById("mainVideo").style.zIndex="2";
}

function sale(){
    document.getElementById("barra").style.zIndex="3";
    document.getElementById("mainVideo").style.zIndex="4";
}
...
function avanzandoEnLaBarra(){
    ...
    var mins = Math.floor(document.getElementById("mainVideo").currentTime/60);
    if(mins<=9) mins = "0"+mins+"";
    var segs = Math.floor(document.getElementById("mainVideo").currentTime%60);
    ...
    if(mins<=9) mins= "0"+mins;
    segs = Math.floor(document.getElementById("mainVideo").duration%60);
    if(segs<=9) segs= "0"+segs;
    document.getElementById("finTiempo").innerText=mins+":"+segs;
}